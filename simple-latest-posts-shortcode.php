...
/**
 * Plugin Name: Simple Latest Posts Shortcode
 * Plugin URI: https://www.kerstner.at/2015/06/wordpress-simple-latest-posts-shortcode-plugin/
 * Description: A simple plugin for rendering latest post previews in a list view using shortcode.
 * Version: 0.1
...
add_shortcode('simple_latest_posts', 'kerstnerat_simple_latest_posts_shortcode');

/**
 * Outputs latest posts using attributes specified.
 * @param array $atts
 * @return string
 */
function kerstnerat_simple_latest_posts($atts) {
    $output = '';
 ...
 * @return string
 */
function kerstnerat_simple_latest_posts_shortcode($atts, $content = null) {
    $originalAtts = $atts;
    ...
    return ($output . kerstnerat_simple_latest_posts($attsCombined));
}
